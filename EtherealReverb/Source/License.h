#pragma once
// EtherealReverb offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/EtherealReverb/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace EtherealReverbLicense
{
    static const char* kProductSecret = "3e55a5d7db140f7d7102c2c7fdfbc3fc9763e0d1b30c46c88c9ae0cc010a7d7b";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("EtherealReverb").getChildFile ("license.json");
    }
