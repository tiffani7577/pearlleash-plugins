...
class EtherealReverbProcessor : public juce::AudioProcessor, public juce::AudioProcessorValueTreeState::Listener
{
public:
          ...
          apvts (*this, nullptr, "PARAMETERS", createParameterLayout())
    {
        ...
        licensed = EtherealReverbLicense::checkLicense();
        if (! licensed)
            juce::Logger::writeToLog ("EtherealReverb: unlicensed copy — enter your serial to activate.");
        ...
        cloudSync.prepare ("com.pearlleash.etherealreverb",
                           juce::String(),
                           "1.0.0");
    ...
    const juce::String getName() const noexcept override { return "EtherealReverb"; }
