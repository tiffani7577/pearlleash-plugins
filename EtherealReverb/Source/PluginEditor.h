...
class EtherealReverbLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
public:
          ...
          webView (makeWebViewOptions())
    {
        ...
        juce::Component::SafePointer<EtherealReverbEditor> safeThis (this);
    ...
    void paint(juce::Graphics& g) override {
        ...
        if (! uiBootstrapped)
        {
            ...
            g.setFont (22.0f);
            g.drawText ("EtherealReverb", getLocalBounds().removeFromTop (48), juce::Justification::centred, true);
            g.setFont (13.0f);
...
private:
    ...
    EtherealReverbLookAndFeel lnf;
    EtherealReverbLookAndFeel::SpriteAtlas bgAtlas;
