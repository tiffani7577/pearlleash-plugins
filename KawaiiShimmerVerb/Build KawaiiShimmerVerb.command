...
clear
echo "═══════════════════════════════════════════"
echo "   PlugForge — Building KawaiiShimmerVerb"
echo "═══════════════════════════════════════════"
echo ""
...
if auval -v aufx VCEk Prll >> .build_log.txt 2>&1; then
...
open "build/KawaiiShimmerVerb_artefacts/Release/Standalone/KawaiiShimmerVerb.app" 2>/dev/null
echo ""
