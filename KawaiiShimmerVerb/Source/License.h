#pragma once
// KawaiiShimmerVerb offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/KawaiiShimmerVerb/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace KawaiiShimmerVerbLicense
{
    static const char* kProductSecret = "0d96293028b81697ab44fbaf700bf26768c371bda5a57ada995eafd66e055cce";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("KawaiiShimmerVerb").getChildFile ("license.json");
    }
