...
class GlowFilterLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class GlowFilterEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit GlowFilterEditor (GlowFilterProcessor& p) : AudioProcessorEditor (p), proc (p)
    {
        loadAssets();
...
private:
    GlowFilterProcessor& proc;
    GlowFilterLookAndFeel lnf;
    GlowFilterLookAndFeel::SpriteAtlas bgAtlas;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GlowFilterEditor)
};
