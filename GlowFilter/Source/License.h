#pragma once
// GlowFilter offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/GlowFilter/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace GlowFilterLicense
{
    static const char* kProductSecret = "ebecd576f7d2719170ed95ed1b96f810fc2e639ec05a09701dcd63581ce69573";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("GlowFilter").getChildFile ("license.json");
    }
