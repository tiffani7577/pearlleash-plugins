...
// NOTE: Do NOT alias ParameterSmoother here. That name is reserved for the
// runtime one-pole smoother (RuntimeParameterSmoother) in ParameterSmoother.h /
// RuntimeParameterSmoother.h. Dual typedefs caused:
//   WoManusParameterSmoothing.h:72: typedef redefinition with different types
//   ('WoManusSmoothedParameter' vs 'ParameterSmoother')
