...
class VelvetAscentLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class VelvetAscentEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit VelvetAscentEditor (VelvetAscentProcessor& p) : AudioProcessorEditor (p), proc (p)
    {
        loadAssets();
...
private:
    VelvetAscentProcessor& proc;
    VelvetAscentLookAndFeel lnf;
    VelvetAscentLookAndFeel::SpriteAtlas bgAtlas;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (VelvetAscentEditor)
};
