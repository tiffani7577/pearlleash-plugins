...
clear
echo "═══════════════════════════════════════════"
echo "   PlugForge — Building VelvetAscent"
echo "═══════════════════════════════════════════"
echo ""
...
if auval -v aufx CVcx Prll >> .build_log.txt 2>&1; then
...
open "build/VelvetAscent_artefacts/Release/Standalone/VelvetAscent.app" 2>/dev/null
echo ""
