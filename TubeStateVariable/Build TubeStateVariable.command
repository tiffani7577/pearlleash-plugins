...
clear
echo "═══════════════════════════════════════════"
echo "   PlugForge — Building TubeStateVariable"
echo "═══════════════════════════════════════════"
echo ""
...
if auval -v aufx ZgOT Prll >> .build_log.txt 2>&1; then
...
open "build/TubeStateVariable_artefacts/Release/Standalone/TubeStateVariable.app" 2>/dev/null
echo ""
