...
class TubeStateVariableLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class TubeStateVariableEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit TubeStateVariableEditor (TubeStateVariableProcessor& p) : AudioProcessorEditor (p), proc (p)
    {
        loadAssets();
...
private:
    TubeStateVariableProcessor& proc;
    TubeStateVariableLookAndFeel lnf;
    TubeStateVariableLookAndFeel::SpriteAtlas bgAtlas;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TubeStateVariableEditor)
};
