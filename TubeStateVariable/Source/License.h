#pragma once
// TubeStateVariable offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/TubeStateVariable/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace TubeStateVariableLicense
{
    static const char* kProductSecret = "3bff20ddaecef4f2f3411a68ad6aa7819c7f8d4b7abedb3790b951539771b258";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("TubeStateVariable").getChildFile ("license.json");
    }
