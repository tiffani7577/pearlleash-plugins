#pragma once
// WarmTapeDelay offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/WarmTapeDelay/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace WarmTapeDelayLicense
{
    static const char* kProductSecret = "711839e5bd1e6af4ea40a0cb12d56c39cb72d3a8c637fe14e217c0e36ca00ad0";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("WarmTapeDelay").getChildFile ("license.json");
    }
