...
class WarmTapeDelayLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class WarmTapeDelayEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit WarmTapeDelayEditor (WarmTapeDelayProcessor& p) : AudioProcessorEditor (p), proc (p)
    {
        loadAssets();
