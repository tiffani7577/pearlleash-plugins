...
clear
echo "═══════════════════════════════════════════"
echo "   PlugForge — Building WarmTapeDelay"
echo "═══════════════════════════════════════════"
echo ""
...
if auval -v aufx uZMm Prll >> .build_log.txt 2>&1; then
...
open "build/WarmTapeDelay_artefacts/Release/Standalone/WarmTapeDelay.app" 2>/dev/null
echo ""
