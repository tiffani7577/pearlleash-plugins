...
class RhythmChopprLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class RhythmChopprEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit RhythmChopprEditor (RhythmChopprProcessor& p) : AudioProcessorEditor (p), proc (p)
    {
        loadAssets();
...
private:
    RhythmChopprProcessor& proc;
    RhythmChopprLookAndFeel lnf;
    RhythmChopprLookAndFeel::SpriteAtlas bgAtlas;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RhythmChopprEditor)
};
