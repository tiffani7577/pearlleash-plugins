...
class EchoSphereProcessor : public juce::AudioProcessor, public juce::AudioProcessorValueTreeState::Listener
{
public:
    EchoSphereProcessor()
          ...
          apvts (*this, nullptr, "PARAMETERS", createParameterLayout())
    {
        ...
        licensed = EchoSphereLicense::checkLicense();
        if (! licensed)
            juce::Logger::writeToLog ("EchoSphere: unlicensed copy — enter your serial to activate.");
        ...
        cloudSync.prepare ("com.pearlleash.echosphere",
                           juce::String(),
                           "1.0.0");
    ...
    const juce::String getName() const noexcept override { return "EchoSphere"; }
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EchoSphereProcessor)
};
