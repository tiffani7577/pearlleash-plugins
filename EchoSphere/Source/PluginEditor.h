...
class EchoSphereLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class EchoSphereEditor : public juce::AudioProcessorEditor,
                      private juce::Timer,
                      private juce::AudioProcessorValueTreeState::Listener
{
public:
    explicit EchoSphereEditor (EchoSphereProcessor& p)
          ...
          webView (makeWebViewOptions())
    {
        ...
        juce::Component::SafePointer<EchoSphereEditor> safeThis (this);
    ...
    void paint(juce::Graphics& g) override {
        ...
        if (! uiBootstrapped)
        {
            ...
            g.setFont (22.0f);
            g.drawText ("EchoSphere", getLocalBounds().removeFromTop (48), juce::Justification::centred, true);
            g.setFont (13.0f);
...
private:
    ...
    EchoSphereLookAndFeel lnf;
    EchoSphereLookAndFeel::SpriteAtlas bgAtlas;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EchoSphereEditor)
};
