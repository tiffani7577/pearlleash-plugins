#pragma once
// CelestialReverb offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/CelestialReverb/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace CelestialReverbLicense
{
    static const char* kProductSecret = "dc8a2ce7a1d300be4b27f8eb1b086bb75882b852f1781a5c58bc9d5ec1046358";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("CelestialReverb").getChildFile ("license.json");
    }
