...
class CelestialReverbLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class CelestialReverbEditor : public juce::AudioProcessorEditor,
                      private juce::Timer,
                      private juce::AudioProcessorValueTreeState::Listener
{
public:
    explicit CelestialReverbEditor (CelestialReverbProcessor& p)
    ...
    {
        loadAssets();
        reverbTimeAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("reverbTime"), reverbTimeRelay, nullptr);
        ...
        proc.apvts.addParameterListener ("reverbTime", this);
        ...
        juce::Component::SafePointer<CelestialReverbEditor> safeThis (this);
    ...
    ~CelestialReverbEditor() override
    {
        stopTimer();
        proc.apvts.removeParameterListener ("reverbTime", this);
    ...
    {
        parameterChanged ("reverbTime", 0.0f);
    ...
    void paint(juce::Graphics& g) override {
        ...
        if (! uiBootstrapped)
        {
            ...
            g.setFont (22.0f);
            g.drawText ("CelestialReverb", getLocalBounds().removeFromTop (48), juce::Justification::centred, true);
            g.setFont (13.0f);
...
private:
    ...
    CelestialReverbLookAndFeel lnf;
    CelestialReverbLookAndFeel::SpriteAtlas bgAtlas;
    juce::WebSliderRelay reverbTimeRelay { "reverbTime" };
    ...
    std::unique_ptr<juce::WebSliderParameterAttachment> reverbTimeAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> gainAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> bypassAttach;
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CelestialReverbEditor)
};
