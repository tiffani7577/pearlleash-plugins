...
class SakuraShimmerLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class SakuraShimmerEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit SakuraShimmerEditor (SakuraShimmerProcessor& p) : AudioProcessorEditor (p), proc (p)
    {
        loadAssets();
...
private:
    SakuraShimmerProcessor& proc;
    SakuraShimmerLookAndFeel lnf;
    SakuraShimmerLookAndFeel::SpriteAtlas bgAtlas;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SakuraShimmerEditor)
};
