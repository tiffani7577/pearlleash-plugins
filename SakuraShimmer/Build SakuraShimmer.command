...
clear
echo "═══════════════════════════════════════════"
echo "   PlugForge — Building SakuraShimmer"
echo "═══════════════════════════════════════════"
echo ""
...
if auval -v aufx jGts Prll >> .build_log.txt 2>&1; then
...
open "build/SakuraShimmer_artefacts/Release/Standalone/SakuraShimmer.app" 2>/dev/null
echo ""
