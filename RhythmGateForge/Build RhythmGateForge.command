...
clear
echo "═══════════════════════════════════════════"
echo "   PlugForge — Building RhythmGateForge"
echo "═══════════════════════════════════════════"
echo ""
...
if auval -v aufx PRhy Prll >> .build_log.txt 2>&1; then
...
open "build/RhythmGateForge_artefacts/Release/Standalone/RhythmGateForge.app" 2>/dev/null
echo ""
