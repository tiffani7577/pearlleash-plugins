#pragma once
// RhythmGateForge offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/RhythmGateForge/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace RhythmGateForgeLicense
{
    static const char* kProductSecret = "d4cfd008984d24cf672ba9fc59e523298fce0deb351310e4029b06b99307d335";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("RhythmGateForge").getChildFile ("license.json");
    }
