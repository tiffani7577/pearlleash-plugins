...
class RhythmGateForgeLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class RhythmGateForgeEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit RhythmGateForgeEditor (RhythmGateForgeProcessor& p) : AudioProcessorEditor (p), proc (p)
    {
        loadAssets();
        patternSlotAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("patternSlot"), patternSlotRelay, nullptr);
...
private:
    RhythmGateForgeProcessor& proc;
    RhythmGateForgeLookAndFeel lnf;
    RhythmGateForgeLookAndFeel::SpriteAtlas bgAtlas;
    juce::WebSliderRelay patternSlotRelay { "patternSlot" };
    ...
    juce::WebBrowserComponent webView {
        juce::WebBrowserComponent::Options{}
            ...
            .withOptionsFrom (patternSlotRelay)
    ...
    std::unique_ptr<juce::WebSliderParameterAttachment> patternSlotAttach;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RhythmGateForgeEditor)
};
