#pragma once
// BuiltinAwareBlend offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/BuiltinAwareBlend/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace BuiltinAwareBlendLicense
{
    static const char* kProductSecret = "f8089edb7957ad935655661da6c1ba5d44ae766ed696d8156da60a8e47fc95d0";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("BuiltinAwareBlend").getChildFile ("license.json");
    }
