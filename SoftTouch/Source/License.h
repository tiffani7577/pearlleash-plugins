#pragma once
// SoftTouch offline license check. Serial = first 20 hex chars of
// HMAC-SHA256(productSecret, lowercase(email)), grouped XXXX-XXXX-XXXX-XXXX-XXXX.
// License file: ~/Library/Application Support/PearlLeashPlugin/SoftTouch/license.json
// Modes: notice (log-only, default) | strict (silence output when unlicensed).
#include <juce_core/juce_core.h>
#include <juce_cryptography/juce_cryptography.h>

namespace SoftTouchLicense
{
    static const char* kProductSecret = "9886e155ac5fb3b3427ecdb4682ad0056953a7a4ef92e6413baff82c9dbc2813";
    ...
    inline juce::File licenseFile()
    {
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
            .getChildFile ("PearlLeashPlugin").getChildFile ("SoftTouch").getChildFile ("license.json");
    }
