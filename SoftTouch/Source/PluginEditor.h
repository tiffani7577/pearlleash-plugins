...
class SoftTouchLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class SoftTouchEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit SoftTouchEditor (SoftTouchProcessor& p) : AudioProcessorEditor (p), proc (p)
    {
        loadAssets();
...
private:
    SoftTouchProcessor& proc;
    SoftTouchLookAndFeel lnf;
    SoftTouchLookAndFeel::SpriteAtlas bgAtlas;
