...
class NebulaReverbLookAndFeel : public juce::LookAndFeel_V4 {
public:
    struct SpriteAtlas {
        juce::Image sheet;
        int frameCount = 1;
...
class NebulaReverbEditor : public juce::AudioProcessorEditor,
                      private juce::Timer,
                      private juce::AudioProcessorValueTreeState::Listener
{
public:
    explicit NebulaReverbEditor (NebulaReverbProcessor& p)
    ...
    {
        loadAssets();
        predelayTimeAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("predelayTime"), predelayTimeRelay, nullptr);
        ...
        timeAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("time"), timeRelay, nullptr);
        ...
        stereoOffsetAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("stereoOffset"), stereoOffsetRelay, nullptr);
        interpQualityAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("interpQuality"), interpQualityRelay, nullptr);
        dualTapAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("dualTap"), dualTapRelay, nullptr);
        tap2OffsetAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("tap2Offset"), tap2OffsetRelay, nullptr);
        tap2MixAttach = std::make_unique<juce::WebSliderParameterAttachment> (*proc.apvts.getParameter ("tap2Mix"), tap2MixRelay, nullptr);
        ...
        proc.apvts.addParameterListener ("predelayTime", this);
        proc.apvts.addParameterListener ("gain", this);
        proc.apvts.addParameterListener ("bypass", this);
        proc.apvts.addParameterListener ("time", this);
        proc.apvts.addParameterListener ("feedback", this);
        proc.apvts.addParameterListener ("mix", this);
        proc.apvts.addParameterListener ("stereoOffset", this);
        proc.apvts.addParameterListener ("interpQuality", this);
        proc.apvts.addParameterListener ("dualTap", this);
        proc.apvts.addParameterListener ("tap2Offset", this);
        proc.apvts.addParameterListener ("tap2Mix", this);
        ...
        juce::Component::SafePointer<NebulaReverbEditor> safeThis (this);
    ...
    ~NebulaReverbEditor() override
    {
        stopTimer();
        proc.apvts.removeParameterListener ("predelayTime", this);
        proc.apvts.removeParameterListener ("gain", this);
        proc.apvts.removeParameterListener ("bypass", this);
        proc.apvts.removeParameterListener ("time", this);
        proc.apvts.removeParameterListener ("feedback", this);
        proc.apvts.removeParameterListener ("mix", this);
        proc.apvts.removeParameterListener ("stereoOffset", this);
        proc.apvts.removeParameterListener ("interpQuality", this);
        proc.apvts.removeParameterListener ("dualTap", this);
        proc.apvts.removeParameterListener ("tap2Offset", this);
        proc.apvts.removeParameterListener ("tap2Mix", this);
    ...
    {
        parameterChanged ("predelayTime", 0.0f);
        parameterChanged ("gain", 0.0f);
        parameterChanged ("bypass", 0.0f);
        parameterChanged ("time", 0.0f);
        parameterChanged ("feedback", 0.0f);
        parameterChanged ("mix", 0.0f);
        parameterChanged ("stereoOffset", 0.0f);
        parameterChanged ("interpQuality", 0.0f);
        parameterChanged ("dualTap", 0.0f);
        parameterChanged ("tap2Offset", 0.0f);
        parameterChanged ("tap2Mix", 0.0f);
    ...
    void paint(juce::Graphics& g) override {
        ...
        if (! uiBootstrapped)
        {
            ...
            g.setFont (22.0f);
            g.drawText ("NebulaReverb", getLocalBounds().removeFromTop (48), juce::Justification::centred, true);
            g.setFont (13.0f);
...
private:
    ...
    NebulaReverbLookAndFeel lnf;
    NebulaReverbLookAndFeel::SpriteAtlas bgAtlas;
    juce::WebSliderRelay predelayTimeRelay { "predelayTime" };
    ...
    juce::WebSliderRelay stereoOffsetRelay { "stereoOffset" };
    juce::WebSliderRelay interpQualityRelay { "interpQuality" };
    juce::WebSliderRelay dualTapRelay { "dualTap" };
    juce::WebSliderRelay tap2OffsetRelay { "tap2Offset" };
    juce::WebSliderRelay tap2MixRelay { "tap2Mix" };
    ...
    juce::WebBrowserComponent::Options makeWebViewOptions()
    {
        auto opts = juce::WebBrowserComponent::Options{}
            ...
            .withOptionsFrom (predelayTimeRelay)
            .withOptionsFrom (gainRelay)
            .withOptionsFrom (bypassRelay)
            .withOptionsFrom (timeRelay)
            .withOptionsFrom (feedbackRelay)
            .withOptionsFrom (mixRelay)
            .withOptionsFrom (stereoOffsetRelay)
            .withOptionsFrom (interpQualityRelay)
            .withOptionsFrom (dualTapRelay)
            .withOptionsFrom (tap2OffsetRelay)
            .withOptionsFrom (tap2MixRelay)
    ...
    std::unique_ptr<juce::WebSliderParameterAttachment> predelayTimeAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> gainAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> bypassAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> timeAttach;
    ...
    std::unique_ptr<juce::WebSliderParameterAttachment> stereoOffsetAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> interpQualityAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> dualTapAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> tap2OffsetAttach;
    std::unique_ptr<juce::WebSliderParameterAttachment> tap2MixAttach;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NebulaReverbEditor)
};
